  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          ...
          Container(
            // containers are similar to div in html
            ...
            decoration: BoxDecoration(
              color: Color(0xff061db1),
              borderRadius: BorderRadius.circular(
                  20), // provides the rounded corner for the box
              boxShadow: [
                BoxShadow(
            ...
            child: Column(
              children: <Widget>[
                ...
                FloatingActionButton(
                  ...
                  hoverColor: Color.fromARGB(255, 208, 55, 137),
                  elevation: 50, // Display updated text
                ),
                Text(buttonText),
                Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      ...
                      Column(children: [Text("sdfsg"), Text("dfgh")])
                    ]),
                ...
                Text(
                  IconButtontxt + "sdf",
                  style: TextStyle(color: Color.fromARGB(255, 245, 239, 239)),
                )
              ],
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.horizontal(
                // horizontal is used instead of circular
                left: Radius.circular(10),
                right: Radius.circular(52),
              ),
            ),
            child: Text(
                "the secound container wich is placed within the parent column"),
          ),
          Column(
            children: [
              Container(
              ...
              Container(
                child: Text(
                    "The above button changes the text to ''floatactbut''  below wallet image ",
